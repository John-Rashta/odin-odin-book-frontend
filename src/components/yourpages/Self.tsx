...
import FormTextFields from "../partials/FormTextFields";
import {
...
import FileDiv from "../partials/FileDiv";
        ...
        {isLoading ? (
          ...
          <>
            <TopContainer>
              ...
              />
              <TopRight>
                <StyledForm onSubmit={handleSubmitImage}>
                  <StyledFormDiv>
            ...
            <StyledTextBottom>
              Joined: {format(data.user.joinedAt, "MM/dd/yyyy")}
            </StyledTextBottom>
