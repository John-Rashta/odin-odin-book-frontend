    ...
    <StyledContainer>
      <div>
        <StyledPostImage
          ...
          src={post.creator.customIcon?.url || post.creator.icon.source}
          alt=""
        />
      </div>
      <StyledMainStuff>
        <StyledTopContainer>
          ...
          <StyledTopRight>
            <StyledEditedDiv>{post.edited ? "Edited" : ""}</StyledEditedDiv>
        ...
        <BottomContainer>
          <StyledFlex>
            <StyledCounts>{post.ownCommentsCount}</StyledCounts>
            <MessageSquare />
          </StyledFlex>
          <BottomRightContainer>
            <StyledCounts>{post.likesCount}</StyledCounts>
            <LikeButton
              myId={myId}
              ...
              clickFunction={(e) => {
                ...
                changeLike({
                  id: post.id,
                  action:
                    post.likes && post.likes.length > 0 ? "REMOVE" : "ADD",
                })
                  .unwrap()
                  .finally(() => {
