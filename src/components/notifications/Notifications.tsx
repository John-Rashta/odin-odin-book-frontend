...
import MiniNotifications from "../partials/MiniNotifications";
import {
...
export default function Notifications() {
  ...
  const { notificationsData, isLoading, error } = useGetNotificationsQuery(
    { id: myId },
    {
  ...
  return (
    <StyledMain>
      <StyledDefaultContainer>
        {isLoading ? (
          <StyledErrorMessage>Loading Notifications...</StyledErrorMessage>
        ) : error ? (
          <StyledErrorMessage>Failed Loading Notifications!</StyledErrorMessage>
          ...
          <StyledErrorMessage>No Notifications Yet!</StyledErrorMessage>
        )}
      </StyledDefaultContainer>
    </StyledMain>
  );
